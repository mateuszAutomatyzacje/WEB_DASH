  ...
  const rows = await sql`
    with src as (
      select distinct on (ma.lead_id)
        ...
        ma.lead_contact_id,
        case
          when ma.follow_up_2_sent_at is not null or ma.follow_up_2_status = 'sent' then 4
          when ma.follow_up_2_scheduled_at is not null or ma.follow_up_2_status = 'scheduled' or ma.follow_up_1_sent_at is not null or ma.follow_up_1_status = 'sent' then 3
          when ma.follow_up_1_scheduled_at is not null or ma.follow_up_1_status = 'scheduled' or ma.sent_at is not null then 2
          else 1
